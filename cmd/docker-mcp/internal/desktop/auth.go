...
import (
	...
	"github.com/jrmatherly/mcp-hub-gateway/cmd/docker-mcp/internal/contextkeys"
)
...
func (c *Tools) PostOAuthApp(
	...
	if oauthEnabled, ok := ctx.Value(contextkeys.OAuthInterceptorEnabledKey).(bool); ok &&
		oauthEnabled {
