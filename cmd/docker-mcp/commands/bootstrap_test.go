...
func TestBootstrapCatalogCommand(t *testing.T) {
	...
	assert.Contains(
		...
		bootstrapContent,
		"registry:",
		"bootstrap catalog should have registry section",
	)
	assert.Contains(
		t,
		bootstrapContent,
		catalog.DockerHubServerName,
		"bootstrap catalog should contain dockerhub server",
	)
	assert.Contains(
		t,
		bootstrapContent,
		catalog.DockerCLIServerName,
		"bootstrap catalog should contain docker server",
	)
...
func TestBootstrapDockerEntriesExtraction(t *testing.T) {
	...
	assert.Contains(
		...
		"should preserve dockerhub description",
	)
	...
	assert.NotContains(
		...
		bootstrapContent,
		"github",
		"should not contain other servers like github",
	)
	assert.NotContains(
		t,
		bootstrapContent,
		"elasticsearch",
		"should not contain other servers like elasticsearch",
	)
}
